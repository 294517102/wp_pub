...
; (function() {
    ...
    We7.Controls.Attachment = We7.extend(We7.Controls.Field, {

        setOptions: function(options) {
            We7.Controls.Attachment.superclass.setOptions.call(this, options);
        },
        ...
        renderComponent: function() {
            ...
            this.warpEl = $.create('div', { className: 'we7-Attachment-wrap' });
    ...
    // Register this class as "Attachment" type
    We7.Control.registerType("Attachment", We7.Controls.Attachment, []);
	 We7.Control.registerType("We7.VideoSelect", We7.Controls.Attachment, []);
})();
