...
namespace We7.CMS.Web.Widgets {
    ...
    [ControlGroupDescription(Label = "无分页文章列表", Icon = "无分页文章列表", Description = "无分页文章列表",
        DefaultType = "ArticleTopic")]
    [ControlDescription(Name = "无分页文章列表控件", Desc = "无分页文章列表控件")]
    public partial class ArticleTopic : ThinkmentDataControl {
        ...
        /// 标题长度
        /// </summary>
        [Parameter(Title = "标题长度", Type = "Number", DefaultValue = "40")] public int TitleLength = 40;
        ...
        /// 自定义Css类名称
        /// </summary>
        [Parameter(Title = "自定义Css类名称", Type = "String", DefaultValue = "ArticleTopic")] public string CssClass;
                                                       ...
                                                       0, PageSize, new string[]
                                                                        {
                                                                            ...
                                                                            "SN", "ContentType", "ContentUrl","Description"
                                                                        });
                }
                return articles;
            }
            ...
            get
            {
                if (channel == null)
                {
                    ...
                    channel = helper.GetChannel(OwnerID, new string[]
                                                             {
                                                                 "ID", "Title", "ChannelFullUrl", "Created", "SN","FullUrl","Description"
                                                             }) ?? new Channel();
                }
                return channel;
            }
        ...
        private List<Article> GetExampleData()
        {
            ...
            for (int i = 0; i < PageSize; i++)
            {
                ...
                temp.Title = "【头条】此处调用新闻头条属性的标题-测试信息" + (i + 1);
                lsResult.Add(temp);
            }
            return lsResult;
        }
