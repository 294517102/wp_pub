...
<body style="background-color:#ffffff;background-position:center top;background-repeat:no-repeat; background-attachment:scroll;background-image:url('/_skins/School/images/all_bg.jpg');">
 ...
 <wew:TopInfo id="TopInfo_147891710671865" cssclass="TopInfo" filename="/Widgets/WidgetCollection/MyParts/TopInfo/TopInfo.ascx" runat="server"></wew:TopInfo></we7design:we7layoutcolumn>
 ...
 <wew:Search2015 id="Search2015_147891709443475" iconwap="" iconhomepage="" iconcollection="" iconrss="" cssclass="Search2015" searchpage="" iconlogin="" filename="/Widgets/WidgetCollection/MyParts/Search2015/Search2015.ascx" runat="server"></wew:Search2015></we7design:we7layoutcolumn>
 ...
 <wew:ChannelMenuV_DropDown id="ChannelMenuV_DropDown_147891710055024" tag="" cssclass="ChannelMenuV_DropDown" filename="/Widgets/WidgetCollection/MyParts/ChannelMenuV.DropDown/ChannelMenuV.DropDown.ascx" runat="server"></wew:ChannelMenuV_DropDown></we7design:we7layoutcolumn>
 ...
 <wew:ChannelMenu_CurrentLocation id="ChannelMenu_CurrentLocation_147891822491770" icon="" cssclass="ChannelMenu_CurrentLocation" filename="/Widgets/WidgetCollection/MyParts/ChannelMenu.CurrLocation/ChannelMenu.CurrentLocation.ascx" runat="server"></wew:ChannelMenu_CurrentLocation><we7design:we7layout runat="server" id="we7layout_147913680266682">
 <we7design:we7layoutcolumn float="left" width="250" widthunit="px" runat="server" id="we7layout_147913680266682_cloumn1" style="" cssclass="">
 ...
 <wew:Sidebar_ChannelNav id="Sidebar_ChannelNav_147911780168746" icon="/_skins/School/images/header_tit01.png" bordercolor="" margintop10="True" cssclass="Sidebar_ChannelNav" ownerid="" filename="/Widgets/WidgetCollection/MyParts/Sidebar.ChannelNav/Sidebar.ChannelNav.ascx" runat="server"></wew:Sidebar_ChannelNav><we7design:we7layout runat="server" id="we7layout_147891828259797">
 <we7design:we7layoutcolumn float="none" widthunit="%" width="100" runat="server" id="we7layout_147891828259797_cloumn1">
 <wew:articlelist_ymd id="ArticleList_YMD_147892184998326" icon="/_skins/School/images/header_tit02.png" marginleft10="False" margintop10="True" bordercolor="" isshow="False" tags="" pagesize="5" ownerid="{89fbf068-cdfe-446c-9d1f-cf8269315d9a}" cssclass="ArticleRight" includechildren="True" dateformat="MM/dd" titlelength="34" filename="/Widgets/WidgetCollection/MyParts/ArticleList.YMD/ArticleList.YMD.ascx" runat="server"></wew:articlelist_ymd><we7design:we7layout runat="server" id="we7layout_147913743932811">
 <we7design:we7layoutcolumn float="none" widthunit="%" width="100" runat="server" id="we7layout_147913743932811_cloumn1">
 <wew:articlelist_ymd id="ArticleList_YMD_147892187694516" icon="/_skins/School/images/header_tit02.png" marginleft10="False" margintop10="True" bordercolor="" isshow="False" tags="" pagesize="5" ownerid="{57626e8b-ab72-416c-a678-94e16e33bd68}" cssclass="ArticleRight" includechildren="True" dateformat="MM/dd" titlelength="34" filename="/Widgets/WidgetCollection/MyParts/ArticleList.YMD/ArticleList.YMD.ascx" runat="server"></wew:articlelist_ymd></we7design:we7layoutcolumn>
</we7design:we7layout></we7design:we7layoutcolumn>
</we7design:we7layout></we7design:we7layoutcolumn>
</we7design:we7layout></we7design:we7layoutcolumn>
 <we7design:we7layoutcolumn float="left" width="30" widthunit="px" runat="server" id="we7layout_147913680266682_cloumn2" style="" cssclass="">
 </we7design:we7layoutcolumn>
  <we7design:we7layoutcolumn float="left" width="780" widthunit="px" runat="server" id="we7layout_147913680266682_cloumn3" style="" cssclass="">
 <wew:PicNewsList id="PicList_147911523755383" margintop10="True" thumbnailtag="PicArticle" dateformat="yyyy/MM/dd" includechildren="True" descriptionlength="200" icon="/_skins/School/images/header_tit05.png" bordercolor="" tags="" isshow="False" pager-requestpageindex="pi" pager-pagerdivclass="page_css page_line" cssclass="PicNewsList" pager-pagesize="10" pager-pagerspanclass="pagecss" ownerid="" titlelength="30" pager-vmtemplatefilename="/Widgets/WidgetCollection/文章列表类/PagedArticleList.Default/vm/pager.vm" pagesize="10" filename="/Widgets/WidgetCollection/MyParts/PicNewsList/PicNewsList.ascx" runat="server"></wew:PicNewsList></we7design:we7layoutcolumn>
</we7design:we7layout></we7design:we7layoutcolumn>
</we7design:we7layout></we7design:we7layoutcolumn>
 ...
 <wew:Footer_Default id="Footer_Default_147891711849673" cssclass="Footer_Default" filename="/Widgets/WidgetCollection/MyParts/Footer.Default/Footer.Default.ascx" runat="server"></wew:Footer_Default></we7design:we7layoutcolumn>
