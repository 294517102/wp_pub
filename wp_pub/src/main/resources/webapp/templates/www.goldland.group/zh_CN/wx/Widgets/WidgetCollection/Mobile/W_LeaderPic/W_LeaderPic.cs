...
namespace We7.CMS.Web.Widgets
{
    ...
    /// 文章分页控件列表
    /// </summary>
    [ControlGroupDescription(Label = "图文分页文章列表", Icon = "图文分页文章列表", Description = "图文分页文章列表", DefaultType = "W_LeaderPic")]
    [ControlDescription(Desc = "U_图片视频分页控件列表")]
    public partial class W_LeaderPic : ThinkmentDataControl
    {
        ...
        /// 文章描述长度
        /// </summary>
        [Parameter(Title = "文章描述长度", Type = "Number", DefaultValue = "60")]
        public int DescriptionLength = 60;

        /// <summary>
        /// 自定义Css类名称
        /// </summary>
        [Parameter(Title = "自定义Css类名称", Type = "String", DefaultValue = "W_LeaderPic")]
            ...
            get
            {
                if (channel == null)
                {
                    ...
                    channel = helper.GetChannel(OwnerID, new string[]
                                                         {
                                                             "ID", "Title","Updated", "ChannelFullUrl","Description", "Created", "SN", "SubTitle", "ContentUrl", "ContentType"
                                                         }) ?? new Channel();
                }
                return channel;
            }
            ...
            get
            {
                if (articles == null)
                {
                    ...
                    articles = Assistant.List<Article>(c, os, startIndex, pageItemsCount,
                                                       new string[] { "ID", "Title", "ChannelFullUrl", "Description", "Created", "SN", "Updated", "Thumbnail", "SubTitle", "ContentUrl", "ContentType" });
