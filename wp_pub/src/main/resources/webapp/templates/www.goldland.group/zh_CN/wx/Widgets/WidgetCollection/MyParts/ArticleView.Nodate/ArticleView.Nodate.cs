...
namespace We7.CMS.Web.Widgets
{
    ...
    /// 文章列表数据提供者
    /// </summary>
    [ControlGroupDescription(Label = "文章详细", Icon = "文章详细", Description = "文章详细", DefaultType = "ArticleView.Nodate")]
    [ControlDescription(Name = "文章详细", Desc = "文章详细控件")]
    public partial class ArticleView_Nodate : ThinkmentDataControl
    {
        /// <summary>
        /// 文章业务助手
        /// </summary>
        ...
        /// 自定义Css类名称
        /// </summary>
        [Parameter(Title = "自定义Css类名称", Type = "String", DefaultValue = "ArticleView_Nodate")]
