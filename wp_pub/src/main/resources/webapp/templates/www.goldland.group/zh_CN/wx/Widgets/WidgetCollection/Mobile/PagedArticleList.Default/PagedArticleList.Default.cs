            ...
            get
            {
                if (channel == null)
                {
                    ...
                    channel = helper.GetChannel(OwnerID, new string[]
                                                         {
                                                             "ID", "Title", "ChannelFullUrl", "Created", "SN","FullUrl", "ContentUrl"
                                                         }) ?? new Channel();
                }
                return channel;
            }
        ...
        protected List<Article> Articles
        {
            get
            {
                ...
                articles = Assistant.List<Article>(criteria, os, startIndex, pageItemsCount,
                                                   new string[] { "ID", "Title", "ChannelFullUrl", "Created", "SN", "Updated", "SubTitle", "ContentUrl", "ContentType","Description"  });
