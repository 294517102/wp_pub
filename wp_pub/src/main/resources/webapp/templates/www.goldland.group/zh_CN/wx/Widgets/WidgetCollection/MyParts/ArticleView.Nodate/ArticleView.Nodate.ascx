<%@ Control Language="C#" AutoEventWireup="true" Debug="true" CodeFile="ArticleView.Nodate.cs"
    Inherits="We7.CMS.Web.Widgets.ArticleView_Nodate" %>
<script type="text/C#" runat="server">
    [ControlDescription(Desc = "文章详细无日期", Author = "wds")]
    string MetaData;
</script>
<div class="<%=Css %>">
...
<script type="text/javascript" language="javascript">
    ...
    //设置附件显示
    if ($(".ArticleView_Nodate .articleAttachments ul li").length == 0)
        $(".ArticleView_Nodate .articleAttachments").hide();
</script>
<%--
tablename:"article"
tabledesc:"文章表"
