...
namespace We7.CMS.Web.Widgets
{
    ...
    /// 文章分页控件列表
    /// </summary>
    [ControlGroupDescription(Label = "PicList图文分页文章列表", Icon = "PicList图文分页文章列表", Description = "PicList图文分页文章列表", DefaultType = "PicList")]
    [ControlDescription(Desc = "PicList图文分页文章列表")]
    public partial class PicList : ThinkmentDataControl
    {
        ...
        /// 自定义Css类名称
        /// </summary>
        [Parameter(Title = "自定义Css类名称", Type = "String", DefaultValue = "PicList")]
