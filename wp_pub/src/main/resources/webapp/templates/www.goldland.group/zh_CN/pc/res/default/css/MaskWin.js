...
MaskWin.prototype = {
    ...
    createMask: function () {
        ...
        this.mask = document.getElementById(MaskWin.maskId) ? document.getElementById(MaskWin.maskId) : this.doc.createElement("DIV");
        this.contentOuter = document.getElementById(MaskWin.contentOuterId) ? document.getElementById(MaskWin.contentOuterId) : this.doc.createElement("DIV");
        ...
        try {
            document.getElementById("scrollshow").style.cssText = "html{overflow:hidden}"
        }
        catch (e) {
    ...
    showMessageProgressBar: function (func, param, callback) {
        var args = {};
    ...
    hide: function (win) {
        win = win || window;
        var outer = document.getElementById("_mask_contentOuter");
        var mask = document.getElementById("_mask_mask");
        var css = document.getElementById("scrollshow");
        if (outer && mask && css) {
            win.document.body.removeChild(document.getElementById("_mask_contentOuter"));
            win.document.body.removeChild(document.getElementById("_mask_mask"));
            try {
                $("#scrollshow").styleSheet.cssText = "";
            }
            catch (e) {
