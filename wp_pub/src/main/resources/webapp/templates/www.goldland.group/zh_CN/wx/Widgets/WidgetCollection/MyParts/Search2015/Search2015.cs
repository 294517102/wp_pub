...
{
    [ControlGroupDescription(Label = "网页头部", Icon = "网页头部", Description = "网页头部", DefaultType = "Search2015")]
    [ControlDescription("U_站点自定义头部")]
    public partial class Search2015 : BaseControl
    {
        /// <summary>
        /// 自定义Css类名称
        /// </summary>
        [Parameter(Title = "自定义Css类名称", Type = "String", DefaultValue = "Search2015")]
