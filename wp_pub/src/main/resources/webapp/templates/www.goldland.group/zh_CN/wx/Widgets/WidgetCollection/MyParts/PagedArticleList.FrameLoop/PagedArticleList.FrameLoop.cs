...
namespace We7.CMS.Web.Widgets
{
    ...
    public partial class PagedArticleList_FrameLoop : ThinkmentDataControl
    {
        ...
        /// 自定义Css类名称
        /// </summary>
        [Parameter(Title = "自定义Css类名称", Type = "String", DefaultValue = "PagedArticleList_FrameLoop")]
            ...
            get
            {
                if (channel == null)
                {
                    ...
                    channel = helper.GetChannel(OwnerID, new string[]
                                                         {
                                                             "ID", "Title", "ChannelFullUrl", "Created", "SN","FullUrl"
                                                         }) ?? new Channel();
                }
                return channel;
            }
        ...
        protected List<Article> Articles
        {
            get
            {
                ...
                articles = Assistant.List<Article>(criteria, os, startIndex, pageItemsCount,
                                                   new string[] { "ID", "Title", "ChannelFullUrl", "Created", "SN", "Updated", "ContentUrl", "ContentType","SubTitle","Description" });
