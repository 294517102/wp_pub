...
namespace We7.CMS.Web.Widgets
{
    ...
    /// 文章列表数据提供者
    /// </summary>
    [ControlGroupDescription(Label = "无分页文章列表", Icon = "无分页文章列表", Description = "无分页文章列表", DefaultType = "TeacherList")]
    [ControlDescription(Name = "无分页文章列表控件", Desc = "无分页文章列表控件")]
    public partial class TeacherList : ThinkmentDataControl
    {
        ...
        /// 自定义Css类名称
        /// </summary>
        [Parameter(Title = "自定义Css类名称", Type = "String", DefaultValue = "TeacherList")]
            ...
            get
            {
                if (articles == null)
                {
                    ...
                    articles = Assistant.List<Article>(c, os, 0, PageSize, new string[]
                                                                           {
                                                                            "ID", "Title", "ChannelFullUrl", "Created", "Updated", "SN", "ContentType", "ContentUrl","SubTitle"
                                                                           });
