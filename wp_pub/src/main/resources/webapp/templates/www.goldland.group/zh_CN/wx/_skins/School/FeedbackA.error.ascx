...
<body style="background-color:rgb(241, 251, 251);background-position:center top;background-repeat:no-repeat; background-attachment:scroll;background-image:url('/_skins/SchoolB/images/all_bg.jpg');">
 ...
 <we7design:we7layoutcolumn float="left" width="780" widthunit="px" runat="server" id="we7layout_147887510222567_cloumn1" style="width:749px; padding:20px 0; padding-right:30px; border-right:1px solid #ddd" cssclass="">
 ...
 <we7design:we7layoutcolumn float="left" width="30" widthunit="px" runat="server" id="we7layout_147887510222567_cloumn2" style="" cssclass="">
 </we7design:we7layoutcolumn>
  <we7design:we7layoutcolumn float="left" width="250" widthunit="px" runat="server" id="we7layout_147887510222567_cloumn3" style="" cssclass="">
 ...
 <wew:Sidebar_ChannelNav control="Sidebar_ChannelNav" filename="/Widgets/WidgetCollection/MyParts/Sidebar.ChannelNav/Sidebar.ChannelNav.ascx" id="Sidebar_ChannelNav_147895567223338" cssclass="Sidebar_ChannelNav" runat="server"></wew:Sidebar_ChannelNav></we7design:we7layoutcolumn>
</we7design:we7layout><we7design:we7layout runat="server" id="we7layout_147895566160232">
 <we7design:we7layoutcolumn float="none" widthunit="%" width="100" runat="server" id="we7layout_147895566160232_cloumn1">
 <span style='color:Red' title='文件“/Widgets/WidgetCollection/商城下载类/Vote.Default/Vote.Default.ascx”不存在。'>此部件发生错误</span></we7design:we7layoutcolumn>
</we7design:we7layout><we7design:we7layout runat="server" id="we7layout_147895565995532">
