...
; (function() {
    ...
    We7.Controls.ChildrenTable = We7.extend(We7.Controls.Field, {
    ...
    We7.Control.registerType("ChildrenTable", We7.Controls.ChildrenTable, [{ Type: "TextBox", Label: "模型名称", Name: "Params.data", Value: ''}]);
